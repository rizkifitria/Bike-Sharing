...
#load data
day = pd.read_csv("https://raw.githubusercontent.com/rizkifitria/Bike-Sharing/main/data/day.csv")
hour = pd.read_csv("https://raw.githubusercontent.com/rizkifitria/Bike-Sharing/main/data/hour.csv")
